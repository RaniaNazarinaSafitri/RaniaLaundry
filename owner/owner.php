...
<div class="row">
<div class="col-sm-12">
    <h4 class="pull-left page-title">Data Owner</h4>
...
<div class='panel panel-border panel-primary'>
    ...
    <p align='left'><a class='btn btn-primary' href='?p=owner&aksi=tambah'><i class='icon-plus'></i>Tambah Owner</a></p>
    <br/>
    <?php
switch($_GET['msg']){
case "input":
...
<table id='datatable' class='table table-hover'>
	<thead>
		...
		<th><i class='icon-terminal'></i> Username Owner</th>
    ...
    <?php
$i=1;
$tp=mysql_query("SELECT * FROM pengguna WHERE Level='Owner' ORDER BY id DESC");
...
<td>$r[nama]</td>
	...
	<td>$r[alamat]</td>
	<td>$r[telp]</td>
	<td><a class='btn btn-primary' href='?p=owner&aksi=edit&id=$r[id]'><i class='icon-edit'></i>Edit</a>
...
<div class='form-group'>
   ...
   <div class='col-lg-10'>
		<input type='text' class='form-control' name='nama' placeholder='Masukan Nama Owner' required>
	</div>
	</div>

<div class='form-group'>
   <label for='cname' class='control-label col-lg-2'>Username Owner</label>
  <div class='col-lg-10'>
		<input type='text' class='form-control' name='username' placeholder='Masukan Username Owner' required>
	</div>
	</div>
...
<div class='form-group'>
  ...
  <div class='col-lg-10'>
  <textarea class='form-control' id='ccomment' name='alamat' required='' aria-required='true' placeholder='Alamat Owner'></textarea>
	</div>
	</div>
...
<div class='form-group'>
    <div class='col-lg-offset-2 col-lg-10'>
		...
		<a class='btn btn-danger' href='?p=owner'>Batal</a>
    </div>
</div>
</form>
</div>
...
echo "<div class='row'>
<div class='col-sm-12'>
    <h4 class='pull-left page-title'>Edit Data Owner</h4>
    <ol class='breadcrumb pull-right'>
        <li><a href='#'>Beranda</a></li>
        <li class='active'>Edit Data Owner</li>
    </ol>
</div>
</div>
...
<div class='col-sm-12'>
<div class='panel panel-default'>
    <div class='panel-heading'><h3 class='panel-title'>Edit Data Owner</h3></div>
    <div class='panel-body'>
        <div class='form'>
		
		<form method='post' action='owner/aksi_owner.php?act=update' class='cmxform form-horizontal tasi-form' id='commentForm'>
        ...
        <label for='cname' class='control-label col-lg-2'>Nama Lengkap</label>
        <div class='col-lg-10'>
             <input type='text' class='form-control' value='$r[nama]' name='nama' placeholder='Masukan Nama Owner' required>
         </div>
         </div>
  ...
  <div class='col-lg-10'>
		<input type='text' class='form-control' name='username'  value='$r[username]' placeholder='Masukan Username Owner' required disabled>
	</div>
	</div>
...
<div class='form-group'>
  ...
  <div class='col-lg-10'>
   ...
   <label for='cname' class='control-label col-lg-2'>Alamat Lengkap</label>
  <div class='col-lg-10'>
  <textarea class='form-control' id='ccomment' name='alamat' required='' aria-required='true' placeholder='Alamat Owner'>$r[alamat]</textarea>
	</div>
	</div>
