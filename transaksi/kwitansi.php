...
$query = mysql_query("SELECT * FROM transaksi WHERE no_order='$_GET[id]'");
$hasil = mysql_fetch_array($query);
$hhh=$hasil['pengguna'];
$query2 = mysql_query("SELECT * FROM pengguna WHERE username='$hhh'");
$hasil2 = mysql_fetch_array($query2);

$query3 = mysql_query("SELECT * FROM identitas");
	...
	<tbody>
		<tr>
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				<tbody>
					<tr>
						<td><span class="editable-area" id="business_info"><p style="font-size: 18pt;"><?php echo"$hasil3[nama_aplikasi]";?> </p>
<p><br> <?php echo"$hasil3[alamat]";?><br> Telphon : <?php echo"$hasil3[tlp]";?><br> Email: <?php echo"$hasil3[email]";?></p></span></td>
					</tr>
				</tbody>
			</table>
			</div>
				...
				<tbody>
					<tr>
						...
						<table cellspacing="0" cellpadding="0" border="0">
							<tbody>
								<tr>
									<td style="padding-left:25px;"><span class="editable-area" id="client_info"><?php echo"$hasil[customer]";?><br>
<?php echo"$hasil[alamat]";?><br>
Telp: <?php echo"$hasil[telp]";?></span></td>
								</tr>
							</tbody>
						</table>
						</div>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tbody>
					<tr>
						...
						<td style="padding-left:20px" align="left"><span class="editable-text" id="no"><?php echo"$hasil[no_order]";?></span></td>
					</tr>
					<tr>
						<td align="right"><strong><span class="editable-text" id="label_date">Outlet</span></strong></td>
						<td style="padding-left:20px" align="left"><span class="editable-text" id="text"><?php echo"$hasil[outlet]";?></span></td>
					</tr>
					<tr>
						<td align="right"><strong><span class="editable-text" id="label_date">Tgl. Transaksi</span></strong></td>
						<td style="padding-left:20px" align="left"><span class="editable-text" id="date"><?php echo"$hasil[tgl_transaksi]";?></span></td>
					</tr>
					<tr>
						<td align="right"><strong><span class="editable-text" id="label_date">Jam Transaksi</span></strong></td>
                        <td style="padding-left:20px" align="left"><span class="editable-text" id="date"><?php echo $hasil['jam_order'];?></span></td>
					</tr>
					
					<tr>
						<td align="right"><strong><span class="editable-text" id="label_date">Tgl. Ambil</span></strong></td>
						<td style="padding-left:20px" align="left"><span class="editable-text" id="date"><?php echo"$hasil[tgl_ambil]";?></span></td>
					</tr>
...
<div id="items-list"><table class="table table-bordered table-condensed table-striped items-table">
    ...
    <tbody>
				<?php
$i=1;
$tp=mysql_query("SELECT * FROM transaksi WHERE no_order ='$_GET[id]'");
...
<?php $i=$i+1;?>
	...
	<tfoot>
			...
			<td coslpan="2"><?php echo'Rp. ' . number_format( $hasil['tarif'], 0 , '' , '.' ) . ',-'?></td>
		</tr>
